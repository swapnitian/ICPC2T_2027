export const chiefPatron = [
  { name: "Prof. N. V. Ramana Rao", role: "Director, NIT Raipur" }
];
...
export const generalChairs = [
  { name: "Prof. Sachin Jain", role: "HOD, Dept. of Electrical Engineering, NIT Raipur" }
];
...
export const publicityChairs = [
  ...
  { name: "Prof. Anamika Yadav", role: "NIT Raipur" },
  { name: "Dr. Rajan Kumar", role: "NIT Raipur" },
  { name: "Dr. D. Suresh", role: "NIT Raipur" },
...
export const internationalAdvisory = [
  { name: "Prof. Bikash Pal", role: "Imperial College London" },
  { name: "Prof. Ayman El-Refaie", role: "Marquette University, USA" },
  { name: "Prof. Sanjib Panda", role: "National University of Singapore" },
  { name: "Prof. Frede Blaabjerg", role: "Aalborg University, Denmark" },
  { name: "Prof. Jih-Sheng (Jason) Lai", role: "Virginia Tech, USA" },
  { name: "Prof. Akshay Rathore", role: "National University of Singapore" },
  { name: "Prof. Ramesh Bansal", role: "University of Pretoria, South Africa" },
...
export const nationalAdvisory = [
  ...
  { name: "Prof. Jyoti Singhi", role: "MANIT Bhopal" },
...
export const technicalProgramCommittee = [
  { name: "Prof. B. Bhattacharyya", role: "IIT (ISM) Dhanbad" },
  { name: "Prof. Parimal Acharjee", role: "NIT Durgapur" },
  { name: "Prof. P. K. Sadhu", role: "IIT (ISM) Dhanbad" },
  { name: "Dr. Rupesh Wandhare", role: "IIT Hyderabad" },
  { name: "Dr. Amit Kumar Jain", role: "IIT Delhi" },
  { name: "Dr. Kalyan Chatterjee", role: "IIT (ISM) Dhanbad" },
  { name: "Dr. Nitika Vats Doohan", role: "SAGE University, Indore" },
  { name: "Dr. Shailendra Kumar Sharma", role: "SGSITS, Indore" },
